...
gulp.task("watch", function () {
  return new Promise((res, rej) => {
    ...
    watch(["./src/.htaccess", "./src/.htpasswd"], gulp.series("destHt"));
    res();
  });
});
...
gulp.task("default", gulp.series("clean",
  gulp.parallel("pug", "styles", "scripts", "destFonts", "destVideos", "destHt", "destPHP", "images", "favicons"),
  gulp.parallel("watch", "serve")
));
//gulp build
gulp.task("build", gulp.series("clean", gulp.parallel("pugBuild", "stylesBuild", "scriptsBuild", "destFonts", "destVideos", "destHt", "destPHP", "images", "favicons")));
//gulp deploy
